...
Είστε σίγουροι ότι επιθυμείτε τη διαγραφή του πελάτη με τα ακόλουθα στοιχεία:

<form class="form-horizontal" action="<?php echo CUSTOMER . "/delete"; ?>" method="post">
  ...
  <div class="control-group">
    <div class="controls">
      ...
      <a href="<?php echo CUSTOMER . "/index"; ?>"><button type="button" class="btn">Επιστροφή</button></a>
    </div>
  </div>
